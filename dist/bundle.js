...
var api = 'https://us-central1-involvement-api.cloudfunctions.net/capstoneApi/apps/JLV3hpmsnDwkVwtlFatp/comments';
var addcommentsToList = function addcommentsToList(comment) {
  var list = document.querySelector('#comment-list');
  var li = document.createElement('li');
  var span = document.createElement('span');
  span.innerHTML = "".concat(comment.creation_date, "  ").concat(comment.username, ":   ").concat(comment.comment);
  li.appendChild(span);
  list.appendChild(li);
  var h3 = document.querySelector('#commentTitle');
  var countComments = (0,_tests_commentCounter_js__WEBPACK_IMPORTED_MODULE_0__.countListItems)(list);
  h3.innerHTML = "Comments(".concat(countComments, ")");
};
var displayComments = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(targetMovie) {
    var comments;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return fetch("".concat(api, "?item_id=").concat(targetMovie));
        case 2:
          _context.next = 4;
        ...
        case 4:
          ...
          comments.forEach(function (comment) {
            return addcommentsToList(comment);
          });
        case 6:
        case "end":
  ...
  return function displayComments(_x) {
...
var postComment = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(item_id, username, comment) {
...
var involve = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var involveData, involveResult;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return fetch('https://us-central1-involvement-api.cloudfunctions.net/capstoneApi/apps/1sJhZQQrIszrR5zukipa/likes/');
        case 3:
          involveData = _context2.sent;
          _context2.next = 6;
          return involveData.json();
        case 6:
          involveResult = _context2.sent;
          // return involveResult;

          involveResult.forEach(function (item) {
...
function createModal(data, targetMovie) {
  var filterResult = data.filter(function (item) {
    return item.id === targetMovie;
  });
  var modal = document.createElement('div');
  modal.classList.add('modal');
  var modalContent = document.createElement('div');
  modalContent.classList.add('modal-content');
  var imageSummaryFrame = document.createElement('div');
  imageSummaryFrame.classList.add('image-summary-frame');
  var imageFrame = document.createElement('div');
  imageFrame.classList.add('image-frame');
  var movieImage = document.createElement('img');
  movieImage.src = "".concat(filterResult[0].image.medium);
  imageFrame.appendChild(movieImage);
  var summaryFrame = document.createElement('div');
  summaryFrame.classList.add('summary-frame');
  var titleFrame = document.createElement('h1');
  titleFrame.classList.add('title-frame');
  titleFrame.innerHTML = "".concat(filterResult[0].name);
  summaryFrame.appendChild(titleFrame);
  var ul = document.createElement('ul');
  ul.innerHTML = "\n    <li><dt>Genre:</dt><dd>".concat(filterResult[0].genres[0], " ").concat(filterResult[0].genres[1], "</dd></li>\n    <li><dt>Type:</dt><dd>").concat(filterResult[0].type, "</dd></li>\n    <li><dt>Language:</dt><dd>").concat(filterResult[0].language, "</dd></li>\n    <li><dt>Summary:</dt><dd>").concat(filterResult[0].summary, "</dd></li>\n  ");
  ...
  form.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(event) {
      var itemId, username, comment;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            event.preventDefault();
            itemId = document.querySelector('#movieId').value;
            ...
            _context.next = 9;
            return (0,_comments_js__WEBPACK_IMPORTED_MODULE_1__.postComment)(itemId, username, comment);
          case 9:
          case "end":
            return _context.stop();
        }
...
function showSelectedMovie(_x2) {
  return _showSelectedMovie.apply(this, arguments);
}
function _showSelectedMovie() {
  _showSelectedMovie = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(targetMovie) {
    var data;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
          return (0,_getMovies_js__WEBPACK_IMPORTED_MODULE_0__.getMovie)();
        case 2:
          data = _context2.sent;
      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          data.forEach(function (item) {
            ...
            name.innerText = "".concat(item.id, ".  ").concat(item.name, " ");
