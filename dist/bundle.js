...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "* {\n  box-sizing: border-box;\n}\n\n.top_section,\n.like_cont,\n.sec,\nfooter,\nbody {\n  display: flex;\n  flex-direction: column;\n}\n\nbody {\n  background-color: #13191c;\n  font-family: \"Roboto\", sans-serif;\n  margin: 0;\n  align-items: center;\n  padding-top: 40px;\n}\n\nheader {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  margin-bottom: 30px;\n  gap: 80px;\n  color: #f4f4f4;\n  font-size: 32px;\n  width: 70%;\n  background-image: linear-gradient(black, rgb(39, 30, 30), gray);\n}\n\n.logo {\n  border: 2px solid #f4f4f4;\n  width: 200px;\n}\n\n.head_cont {\n  width: 70%;\n  height: auto;\n  display: flex;\n  justify-content: space-between;\n  border: 2px solid red;\n}\n\n.head_size {\n  width: 60%;\n}\n\n.item_number {\n  text-decoration: underline;\n}\n\n.grid_container {\n  display: grid;\n  grid-template-columns: 1fr 1fr 1fr 1fr;\n  gap: 40px;\n  width: 70%;\n  height: auto;\n  margin-bottom: 80px;\n  border: 2px solid red;\n}\n\n.grid_img {\n  border-radius: 5px;\n  width: 100%;\n  height: 400px;\n  border: 1px solid #f4f4f4;\n}\n\n.sec {\n  justify-content: space-between;\n  /*width: 290px;*/\n  width: 100%;\n  height: 600px;\n  border-radius: 8px;\n}\n\n.space_like {\n  display: flex;\n  justify-content: space-between;\n  color: #f4f4f4;\n  font-size: 20px;\n  width: 100%;\n  height: 100px;\n}\n\n.like_cont {\n  height: auto;\n}\n\nbutton {\n  width: 80px;\n  height: 70px;\n  border: 2px solid rgb(221, 32, 32);\n  border-radius: 8px;\n  margin-bottom: 5px;\n}\n\n.comment {\n  width: 100%;\n  height: 70px;\n  font-size: 32px;\n  color: white;\n  background: black;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  border: 2px solid white;\n  border-radius: 5px;\n}\n\nfooter {\n  border-top: 2px solid #f4f4f4;\n  width: 100%;\n  height: 150px;\n  justify-content: center;\n  padding-left: 40px;\n  font-size: 32px;\n  color: #f4f4f4;\n  background: red;\n}\n\n@media screen and (max-width: 480px) {\n  .grid_container {\n    grid-template-columns: 1fr 1fr;\n  }\n}", "",{"version":3,"sources":["webpack://./src/styles/main.scss"],"names":[],"mappings":"AAMA;EACE,sBAAA;AAJF;;AAOA;;;;;EAKE,aAAA;EACA,sBAAA;AAJF;;AAOA;EACE,yBAlBc;EAmBd,iCAAA;EACA,SAAA;EACA,mBAAA;EACA,iBAAA;AAJF;;AAOA;EACE,aAAA;EACA,mBAAA;EACA,8BAAA;EACA,mBAAA;EACA,SAAA;EACA,cA9BgB;EA+BhB,eAAA;EACA,UAAA;EACA,+DAAA;AAJF;;AAOA;EACE,yBAAA;EACA,YAAA;AAJF;;AAOA;EACE,UAAA;EACA,YAAA;EACA,aAAA;EACA,8BAAA;EAA+B,qBAAA;AAHjC;;AAMA;EACE,UAAA;AAHF;;AAMA;EACE,0BAAA;AAHF;;AAMA;EACE,aAAA;EACA,sCAAA;EACA,SAAA;EACA,UAAA;EACA,YAAA;EACA,mBAAA;EAAqB,qBAAA;AAFvB;;AAKA;EACE,kBAAA;EACA,WAAA;EACA,aAAA;EACA,yBAAA;AAFF;;AAKA;EACE,8BAAA;EACA,gBAAA;EACA,WAAA;EACA,aAAA;EACA,kBAAA;AAFF;;AAKA;EACE,aAAA;EACA,8BAAA;EACA,cAnFgB;EAoFhB,eAAA;EACA,WAAA;EACA,aAAA;AAFF;;AAKA;EACE,YAAA;AAFF;;AAKA;EACE,WAAA;EACA,YAAA;EACA,kCAAA;EACA,kBAAA;EACA,kBAAA;AAFF;;AAKA;EACE,WAAA;EACA,YAAA;EACA,eAAA;EACA,YAAA;EACA,iBAAA;EACA,aAAA;EACA,uBAAA;EACA,mBAAA;EACA,uBAAA;EACA,kBAAA;AAFF;;AAKA;EACE,6BAAA;EACA,WAAA;EACA,aAAA;EACA,uBAAA;EACA,kBAAA;EACA,eAAA;EACA,cAzHgB;EA0HhB,eAAA;AAFF;;AAKA;EACE;IACE,8BAAA;EAFF;AACF","sourcesContent":["@import url('https://fonts.googleapis.com/css2?family=Roboto:wght@400;700&display=swap');\n\n$primary-color: #13191c;\n$secondary-color: #f4f4f4;\n$box-shadow: 0 10px 20px rgba(0, 0, 0, 0.1), 0 6px 6px rgba(0, 0, 0, 0.1);\n\n* {\n  box-sizing: border-box;\n}\n\n.top_section,\n.like_cont,\n.sec,\nfooter,\nbody {\n  display: flex;\n  flex-direction: column;\n}\n\nbody {\n  background-color: $primary-color;\n  font-family: 'Roboto', sans-serif;\n  margin: 0;\n  align-items: center;\n  padding-top: 40px;\n}\n\nheader {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  margin-bottom: 30px;\n  gap: 80px;\n  color: $secondary-color;\n  font-size: 32px;\n  width: 70%;\n  background-image: linear-gradient(black, rgb(39, 30, 30),gray);\n}\n\n.logo {\n  border: 2px solid $secondary-color;\n  width: 200px;\n}\n\n.head_cont {\n  width: 70%;\n  height: auto;\n  display: flex;\n  justify-content: space-between;border: 2px solid red;\n}\n\n.head_size {\n  width: 60%;\n}\n\n.item_number {\n  text-decoration: underline;\n}\n\n.grid_container {\n  display: grid;\n  grid-template-columns: 1fr 1fr 1fr 1fr;\n  gap: 40px;\n  width: 70%;\n  height: auto;\n  margin-bottom: 80px; border: 2px solid red;\n}\n\n.grid_img {\n  border-radius: 5px;\n  width: 100%;\n  height: 400px;\n  border: 1px solid $secondary-color;\n}\n\n.sec {\n  justify-content: space-between;\n  /*width: 290px;*/\n  width: 100%;\n  height: 600px;\n  border-radius: 8px;\n}\n\n.space_like {\n  display: flex;\n  justify-content: space-between;\n  color: $secondary-color;\n  font-size: 20px;\n  width: 100%;\n  height: 100px;\n}\n\n.like_cont {\n  height: auto;\n}\n\nbutton {\n  width: 80px;\n  height: 70px; \n  border: 2px solid rgb(221, 32, 32);\n  border-radius: 8px;\n  margin-bottom: 5px;\n}\n\n.comment {\n  width: 100%;\n  height: 70px;\n  font-size: 32px;\n  color: white;\n  background: black;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  border: 2px solid white;\n  border-radius: 5px;\n}\n\nfooter {\n  border-top: 2px solid $secondary-color;\n  width: 100%;\n  height: 150px;\n  justify-content: center;\n  padding-left: 40px;\n  font-size: 32px;\n  color: $secondary-color;\n  background: red;\n}\n\n@media screen and (max-width: 480px) {\n  .grid_container {\n    grid-template-columns: 1fr 1fr;\n  }\n\n  \n  \n}\n"],"sourceRoot":""}]);
// Exports
