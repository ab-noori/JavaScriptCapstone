...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "* {\n  box-sizing: border-box;\n}\n\n.like_cont,\n.sec,\nfooter,\nbody {\n  display: flex;\n  flex-direction: column;\n}\n\nbody {\n  background-color: #13191c;\n  font-family: \"Roboto\", sans-serif;\n  margin: 0;\n  align-items: center;\n  /*padding-top: 40px;*/\n}\n\nheader {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  margin-bottom: 30px;\n  gap: 80px;\n  color: #f4f4f4;\n  font-size: 32px;\n  width: 70%;\n  border: 2px solid red;\n  height: auto;\n  background-image: linear-gradient(black, rgb(39, 30, 30), gray);\n}\n\n.logo {\n  border: 2px solid #f4f4f4;\n  width: 200px;\n}\n\n.head_cont {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  border: 2px solid green;\n  width: 70%;\n  height: 120px;\n}\n\n.head_size {\n  width: 60%;\n  flex-grow: 10;\n  border: 2px solid red;\n}\n\n.item_number {\n  text-decoration: underline;\n}\n\n.grid_container {\n  display: grid;\n  grid-template-columns: 1fr 1fr 1fr 1fr;\n  gap: 20px;\n  width: 70%;\n  height: auto;\n  margin-bottom: 80px;\n  border: 2px solid white;\n}\n\n.grid_img {\n  border-radius: 5px;\n  width: 100%;\n  height: 400px;\n  border: 1px solid #f4f4f4;\n}\n\n.grid_img:hover {\n  border: 2px solid red;\n}\n\n.sec {\n  justify-content: space-between;\n  width: 100%;\n  height: 600px;\n  border-radius: 8px;\n}\n\n.space_like {\n  display: flex;\n  justify-content: space-between;\n  color: #f4f4f4;\n  font-size: 20px;\n  width: 100%;\n  height: 80px;\n  margin-bottom: 0;\n  border: 2px solid green;\n}\n\n.like_cont {\n  height: auto;\n  border: 2px solid red;\n}\n\nbutton {\n  width: 60px;\n  height: 50px;\n  border-radius: 8px;\n  margin-bottom: 5px;\n}\n\n.comment {\n  display: flex;\n  width: 100%;\n  height: 70px;\n  font-size: 32px;\n  color: #f4f4f4;\n  background: black;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  border: 2px solid #f4f4f4;\n  border-radius: 5px;\n}\n\nfooter {\n  border-top: 2px solid #f4f4f4;\n  width: 100%;\n  height: 80px;\n  justify-content: center;\n  padding-left: 40px;\n  font-size: 32px;\n  color: #f4f4f4;\n  background: red;\n}\n\n/*\n@media screen and (max-width: 768px) {\n  .grid_container {\n    grid-template-columns: 1fr 1fr;\n  } \n\n}*/", "",{"version":3,"sources":["webpack://./src/styles/main.scss"],"names":[],"mappings":"AAMA;EACE,sBAAA;AAJF;;AAOA;;;;EAIE,aAAA;EACA,sBAAA;AAJF;;AAOA;EACE,yBAjBc;EAkBd,iCAAA;EACA,SAAA;EACA,mBAAA;EACA,qBAAA;AAJF;;AAOA;EACE,aAAA;EACA,mBAAA;EACA,8BAAA;EACA,mBAAA;EACA,SAAA;EACA,cA7BgB;EA8BhB,eAAA;EACA,UAAA;EAAW,qBAAA;EACX,YAAA;EACA,+DAAA;AAHF;;AAMA;EACE,yBAAA;EACA,YAAA;AAHF;;AAMA;EACE,aAAA;EACA,mBAAA;EACA,8BAAA;EAA+B,uBAAA;EAC/B,UAAA;EACA,aAAA;AAFF;;AAKA;EACE,UAAA;EACA,aAAA;EAAe,qBAAA;AADjB;;AAIA;EACE,0BAAA;AADF;;AAIA;EACE,aAAA;EACA,sCAAA;EACA,SAAA;EACA,UAAA;EACA,YAAA;EACA,mBAAA;EAAoB,uBAAA;AAAtB;;AAGA;EACE,kBAAA;EACA,WAAA;EACA,aAAA;EACA,yBAAA;AAAF;;AAGA;EACE,qBAAA;AAAF;;AAGA;EACE,8BAAA;EACA,WAAA;EACA,aAAA;EACA,kBAAA;AAAF;;AAGA;EACE,aAAA;EACA,8BAAA;EACA,cAxFgB;EAyFhB,eAAA;EACA,WAAA;EACA,YAAA;EACA,gBAAA;EAAiB,uBAAA;AACnB;;AAEA;EACE,YAAA;EAAa,qBAAA;AAEf;;AACA;EACE,WAAA;EACA,YAAA;EACA,kBAAA;EACA,kBAAA;AAEF;;AACA;EACE,aAAA;EACA,WAAA;EACA,YAAA;EACA,eAAA;EACA,cA/GgB;EAgHhB,iBAAA;EACA,aAAA;EACA,uBAAA;EACA,mBAAA;EACA,yBAAA;EACA,kBAAA;AAEF;;AACA;EACE,6BAAA;EACA,WAAA;EACA,YAAA;EACA,uBAAA;EACA,kBAAA;EACA,eAAA;EACA,cA/HgB;EAgIhB,eAAA;AAEF;;AAAA;;;;;;EAAA","sourcesContent":["@import url('https://fonts.googleapis.com/css2?family=Roboto:wght@400;700&display=swap');\n\n$primary-color: #13191c;\n$secondary-color: #f4f4f4;\n$box-shadow: 0 10px 20px rgba(0, 0, 0, 0.1), 0 6px 6px rgba(0, 0, 0, 0.1);\n\n* {\n  box-sizing: border-box;\n}\n\n.like_cont,\n.sec,\nfooter,\nbody {\n  display: flex;\n  flex-direction: column;\n}\n\nbody {\n  background-color: $primary-color;\n  font-family: 'Roboto', sans-serif;\n  margin: 0;\n  align-items: center;\n  /*padding-top: 40px;*/\n}\n\nheader {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  margin-bottom: 30px;\n  gap: 80px;\n  color: $secondary-color;\n  font-size: 32px;\n  width: 70%;border: 2px solid red;\n  height: auto;\n  background-image: linear-gradient(black, rgb(39, 30, 30),gray);\n}\n\n.logo {\n  border: 2px solid $secondary-color;\n  width: 200px;\n}\n\n.head_cont {\n  display: flex;\n  align-items: center;  \n  justify-content: space-between;border: 2px solid green;\n  width: 70%;\n  height: 120px;\n}\n\n.head_size {\n  width: 60%;\n  flex-grow: 10; border: 2px solid red;\n}\n\n.item_number {\n  text-decoration: underline;\n}\n\n.grid_container {\n  display: grid;\n  grid-template-columns: 1fr 1fr 1fr 1fr;\n  gap: 20px;\n  width: 70%;\n  height: auto;\n  margin-bottom: 80px;border: 2px solid white;\n}\n\n.grid_img {\n  border-radius: 5px;\n  width: 100%;\n  height: 400px;\n  border: 1px solid $secondary-color;\n}\n\n.grid_img:hover {\n  border: 2px solid red;\n}\n\n.sec {\n  justify-content: space-between;\n  width: 100%;\n  height: 600px;\n  border-radius: 8px;\n}\n\n.space_like {\n  display: flex;\n  justify-content: space-between;\n  color: $secondary-color;\n  font-size: 20px;\n  width: 100%;\n  height: 80px;\n  margin-bottom: 0;border: 2px solid green;\n}\n\n.like_cont {\n  height: auto;border: 2px solid red;\n}\n\nbutton {\n  width: 60px;\n  height: 50px;\n  border-radius: 8px;\n  margin-bottom: 5px;\n}\n\n.comment {\n  display: flex;\n  width: 100%;\n  height: 70px;\n  font-size: 32px;\n  color: $secondary-color;\n  background: black;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  border: 2px solid $secondary-color;\n  border-radius: 5px;\n}\n\nfooter {\n  border-top: 2px solid $secondary-color;\n  width: 100%;\n  height: 80px;\n  justify-content: center;\n  padding-left: 40px;\n  font-size: 32px;\n  color: $secondary-color;\n  background: red;\n}\n/*\n@media screen and (max-width: 768px) {\n  .grid_container {\n    grid-template-columns: 1fr 1fr;\n  } \n  \n}*/\n"],"sourceRoot":""}]);
// Exports
...
async function display(data) {
  ...
  data.forEach(item => {
    ...
    const dispLikes = async () => {
      const like = await (0,_modules_getMovies_js__WEBPACK_IMPORTED_MODULE_2__.getLikes)();
      like.forEach(id => {
...
async function show() {
  const showMovie = await (0,_modules_getMovies_js__WEBPACK_IMPORTED_MODULE_2__.getMovie)();
  display(showMovie);
}
show();
})();
